...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000132)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-suppyr-deepfs-nmlsy000132-model/model.yaml
```
