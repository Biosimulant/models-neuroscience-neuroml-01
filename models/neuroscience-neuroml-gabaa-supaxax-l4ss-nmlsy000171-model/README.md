...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000171)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-supaxax-l4ss-nmlsy000171-model/model.yaml
```
