...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000107)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5ib-deeplts-nmlsy000107-model/model.yaml
```
