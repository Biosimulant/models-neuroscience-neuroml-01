...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY001602)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-nmda-synapse-nmlsy001602-model/model.yaml
```
