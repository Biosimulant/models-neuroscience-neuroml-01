...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000124)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l6nt-l4ss-nmlsy000124-model/model.yaml
```
