...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000106)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5ib-deepfs-nmlsy000106-model/model.yaml
```
