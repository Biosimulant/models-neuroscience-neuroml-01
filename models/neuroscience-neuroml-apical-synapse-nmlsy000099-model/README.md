...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000099)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-apical-synapse-nmlsy000099-model/model.yaml
```
