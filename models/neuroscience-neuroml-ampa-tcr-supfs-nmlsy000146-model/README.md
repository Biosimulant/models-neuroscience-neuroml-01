...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000146)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-tcr-supfs-nmlsy000146-model/model.yaml
```
