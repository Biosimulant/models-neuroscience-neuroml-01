...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY001634)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gaba-synapse-nmlsy001634-model/model.yaml
```
