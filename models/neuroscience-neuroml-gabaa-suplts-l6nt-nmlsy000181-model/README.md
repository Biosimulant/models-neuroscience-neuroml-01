...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000181)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-suplts-l6nt-nmlsy000181-model/model.yaml
```
