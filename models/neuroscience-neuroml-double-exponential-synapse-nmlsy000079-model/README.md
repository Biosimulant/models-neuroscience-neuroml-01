...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000079)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-double-exponential-synapse-nmlsy000079-model/model.yaml
```
