...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000115)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5rs-deeplts-nmlsy000115-model/model.yaml
```
