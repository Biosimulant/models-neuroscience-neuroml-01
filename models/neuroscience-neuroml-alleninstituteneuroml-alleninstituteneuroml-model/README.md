...
**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/AllenInstituteNeuroML)
**Standard**: neuroml
...
models:
  - path: ../../models/neuroscience-neuroml-alleninstituteneuroml-alleninstituteneuroml-model
    alias: model
```
