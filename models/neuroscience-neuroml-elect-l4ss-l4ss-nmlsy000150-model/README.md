...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000150)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-elect-l4ss-l4ss-nmlsy000150-model/model.yaml
```
