...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000139)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-suppyr-suppyr-nmlsy000139-model/model.yaml
```
