...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000168)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-nrt-nrt-s-nmlsy000168-model/model.yaml
```
