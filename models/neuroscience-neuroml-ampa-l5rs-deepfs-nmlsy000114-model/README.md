...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000114)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5rs-deepfs-nmlsy000114-model/model.yaml
```
