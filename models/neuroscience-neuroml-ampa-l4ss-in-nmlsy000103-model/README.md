...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000103)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l4ss-in-nmlsy000103-model/model.yaml
```
