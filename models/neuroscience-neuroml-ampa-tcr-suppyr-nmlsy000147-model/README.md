...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000147)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-tcr-suppyr-nmlsy000147-model/model.yaml
```
