...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000152)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-elect-suppyr-suppyr-nmlsy000152-model/model.yaml
```
