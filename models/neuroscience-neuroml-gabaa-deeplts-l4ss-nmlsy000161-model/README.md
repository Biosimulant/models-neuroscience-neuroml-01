...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000161)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-deeplts-l4ss-nmlsy000161-model/model.yaml
```
