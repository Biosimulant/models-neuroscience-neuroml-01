...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000164)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-deeplts-l6nt-nmlsy000164-model/model.yaml
```
