...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY001643)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-double-exponential-synapse-nmlsy001643-model/model.yaml
```
