...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000182)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-suplts-lts-nmlsy000182-model/model.yaml
```
