...
**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/BlueBrainProjectShowcase)
**Standard**: neuroml
...
models:
  - path: ../../models/neuroscience-neuroml-bluebrainprojectshowcase-bluebrainprojectshowcase-model
    alias: model
```
