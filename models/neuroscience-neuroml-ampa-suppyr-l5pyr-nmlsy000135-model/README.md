...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000135)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-suppyr-l5pyr-nmlsy000135-model/model.yaml
```
