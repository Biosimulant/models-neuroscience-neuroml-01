...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000120)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5rs-suplts-nmlsy000120-model/model.yaml
```
