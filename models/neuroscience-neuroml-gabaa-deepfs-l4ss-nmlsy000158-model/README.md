...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000158)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-deepfs-l4ss-nmlsy000158-model/model.yaml
```
