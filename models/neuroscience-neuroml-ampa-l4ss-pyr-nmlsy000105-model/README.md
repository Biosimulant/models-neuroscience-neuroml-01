...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000105)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l4ss-pyr-nmlsy000105-model/model.yaml
```
