...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000084)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gap-junction-nmlsy000084-model/model.yaml
```
