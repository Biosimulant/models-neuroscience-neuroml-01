#!/usr/bin/env python3
"""Run generated space: neuroscience-general-combo-0076."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-general-combo-0076')} duration={duration} tick_dt={tick_dt}")
