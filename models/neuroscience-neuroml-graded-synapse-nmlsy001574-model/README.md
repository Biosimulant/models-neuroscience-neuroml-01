...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY001574)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-graded-synapse-nmlsy001574-model/model.yaml
```
