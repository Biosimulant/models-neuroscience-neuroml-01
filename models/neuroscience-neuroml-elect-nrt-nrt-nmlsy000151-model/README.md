...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000151)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-elect-nrt-nrt-nmlsy000151-model/model.yaml
```
