...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000153)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-deepaxax-pyr-nmlsy000153-model/model.yaml
```
