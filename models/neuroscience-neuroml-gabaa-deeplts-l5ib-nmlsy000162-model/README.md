...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000162)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-deeplts-l5ib-nmlsy000162-model/model.yaml
```
