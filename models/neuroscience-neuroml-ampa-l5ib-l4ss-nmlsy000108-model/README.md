...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000108)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5ib-l4ss-nmlsy000108-model/model.yaml
```
