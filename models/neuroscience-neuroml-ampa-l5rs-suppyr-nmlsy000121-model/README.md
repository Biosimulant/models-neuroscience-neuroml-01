...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000121)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5rs-suppyr-nmlsy000121-model/model.yaml
```
