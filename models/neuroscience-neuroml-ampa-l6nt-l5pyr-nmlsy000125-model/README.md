...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000125)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l6nt-l5pyr-nmlsy000125-model/model.yaml
```
