...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY001596)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-synapse-nmlsy001596-model/model.yaml
```
