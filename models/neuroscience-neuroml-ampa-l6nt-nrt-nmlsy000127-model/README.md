...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000127)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l6nt-nrt-nmlsy000127-model/model.yaml
```
