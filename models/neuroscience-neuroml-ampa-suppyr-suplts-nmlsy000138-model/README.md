...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000138)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-suppyr-suplts-nmlsy000138-model/model.yaml
```
