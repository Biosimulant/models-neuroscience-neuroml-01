...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000179)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-suplts-l4ss-nmlsy000179-model/model.yaml
```
