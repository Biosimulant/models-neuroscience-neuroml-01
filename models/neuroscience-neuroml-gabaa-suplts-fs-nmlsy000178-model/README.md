...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000178)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-suplts-fs-nmlsy000178-model/model.yaml
```
