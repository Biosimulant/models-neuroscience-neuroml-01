...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000180)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-suplts-l5pyr-nmlsy000180-model/model.yaml
```
