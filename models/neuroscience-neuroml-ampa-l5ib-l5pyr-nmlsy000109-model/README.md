...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000109)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l5ib-l5pyr-nmlsy000109-model/model.yaml
```
