...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000104)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l4ss-l4ss-nmlsy000104-model/model.yaml
```
