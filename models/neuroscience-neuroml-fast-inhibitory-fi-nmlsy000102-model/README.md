...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000102)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-fast-inhibitory-fi-nmlsy000102-model/model.yaml
```
