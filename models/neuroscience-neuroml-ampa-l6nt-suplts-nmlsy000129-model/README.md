...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000129)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-l6nt-suplts-nmlsy000129-model/model.yaml
```
