...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000137)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-suppyr-supfs-nmlsy000137-model/model.yaml
```
