...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000148)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-elect-cortin-cortin-nmlsy000148-model/model.yaml
```
