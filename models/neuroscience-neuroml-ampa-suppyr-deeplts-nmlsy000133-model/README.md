...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000133)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-ampa-suppyr-deeplts-nmlsy000133-model/model.yaml
```
