...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000169)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-gabaa-nrt-tcr-s-nmlsy000169-model/model.yaml
```
